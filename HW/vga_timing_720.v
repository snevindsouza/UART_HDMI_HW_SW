module vga_timing_720 #(
  parameter   HVID = 1280,   // horizontal active video width pix clocks
  parameter   HFP  = 110,    // horizontal front porch pix clocks
  parameter   HS   = 40,     // horizontal hsync pulse width pix clocks
  parameter   HBP  = 220,    // horizontal back porch pix clocks
  parameter   VVID = 720,    // vertical active video lines
  parameter   VFP  = 5,      // vertical front porch video lines
  parameter   VS   = 5,      // vertical vsync pulse width video lines
  parameter   VBP  = 20,     // vertical back porch video lines
